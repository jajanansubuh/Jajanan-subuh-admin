...
-- CreateIndex
CREATE INDEX "Banner_storeId_idx" ON "public"."Banner"("storeId");

-- CreateIndex
CREATE INDEX "Category_storeId_idx" ON "public"."Category"("storeId");

-- CreateIndex
CREATE INDEX "Category_bannerId_idx" ON "public"."Category"("bannerId");
...
-- AddForeignKey
ALTER TABLE "public"."Banner" ADD CONSTRAINT "Banner_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "public"."Store"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Category" ADD CONSTRAINT "Category_bannerId_fkey" FOREIGN KEY ("bannerId") REFERENCES "public"."Banner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
